...
if ( !class_exists('Puc_v4p10_UpdateChecker', false) ):
	...
	abstract class Puc_v4p10_UpdateChecker {
		...
		protected function requestMetadata($metaClass, $filterRoot, $queryArgs = array()) {
			...
			{	// Validamos si se trata de un error de permisos. En ese caso, terminamos silencioasamente
				if (isset($status->errors['401']))
				{
					// Para evitar mensajes de error si no nos dan 
					$result   = null;
				}
				else
				{
